...
export class CharactersListComponent {
	...
	protected readonly characterSheetRoute = `/${RoutesConfigs.talesFromTheLoop}/${RoutesConfigs.characterSheet.path}`;
	...
	protected navigateToCharacterCreation(): void {
		...
		this.router.navigate(["/", RoutesConfigs.talesFromTheLoop, RoutesConfigs.characterSheet.path, uniqKey]);
	}
}
